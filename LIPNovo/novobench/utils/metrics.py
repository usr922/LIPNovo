...
from .constants import CARBON_MASS_DELTA
from .constants import H2O_MASS
from .constants import PROTON_MASS_AMU

#adapted from https://github.com/instadeepai/InstaNovo/blob/main/instanovo/utils/metrics.py
class Metrics:
